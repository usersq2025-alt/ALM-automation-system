...
st.markdown(
    ...
    .section-title {
        padding: 0.4rem 0.8rem; border-right: 4px solid #6b3fa0;
        background: linear-gradient(90deg, rgba(107,63,160,0.07), transparent);
        border-radius: 0 8px 8px 0; border-bottom: none !important;
    }
